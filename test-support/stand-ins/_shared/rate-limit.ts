...
//
// Stands in for: supabase/functions/_shared/rate-limit.ts
// What that is:  The platform's rate limiter, which writes the production database. It is not published.
//
...
export const hashedEntityKey = unavailable('supabase/functions/_shared/rate-limit.ts hashedEntityKey')
