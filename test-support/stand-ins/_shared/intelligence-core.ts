...
//
// Stands in for: supabase/functions/_shared/intelligence-core.ts
// What that is:  The platform-wide intelligence store, which reads and writes the production database. It is not published.
//
...
export const assembleIntelligenceContext = unavailable('supabase/functions/_shared/intelligence-core.ts assembleIntelligenceContext')
