 ...
 * Share button on the chart. This keeps the same one-snapshot-per-link rule and
 * simply performs the save in front of the person, showing the card the
 * recipient will see first. */
export default function ChartShareLaunch({context,captureLayout,seriesCapture=null,chartSource=null,latestObservation=null,disabled=false}) {
