  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="page-sub">{t('pages.comment_king_sub', { defaultValue: 'Draft replies and reactions, then copy them to your clipboard.' })}</p>
      </div>

      {/* Drafting a reply runs a fresh request for the asking member, so the
          composer and its drafts are the part that locks. The header above
          stays, and the lock names the plan that opens it. */}
      <IntelSurfaceGate surface="comment_king" title={t('nav.comment_king', { defaultValue: 'Comment King' })}>
        <div className="space-y-5">
