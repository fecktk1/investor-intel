...
Deno.test('Shared image price pipeline preserves fallbacks and timestamps',async t=>{
  ...
  try{
    ...
    const {fetchPriceSnapshot,buildSnapshotBlock}=await import('../price-snapshot.ts')
